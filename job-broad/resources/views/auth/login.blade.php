<x-layout-simple :title="$pageTitle">
    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-indigo-700">Login In Your Account</h2>
        </div>

        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form action="/login" method="POST" class="space-y-6 outline p-9 rounded-2xl outline-gray-200">
                @csrf
                ...
                <p class="mt-10 text-center text-sm/6 text-gray-500">
                    ...
                    <a href="/signup" class="font-semibold text-indigo-600 hover:text-indigo-500">Register Now !</a>
                </p>
